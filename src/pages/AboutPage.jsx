...
export default function AboutPage() {
  return (
    <div className="pt-16 bg-white dark:bg-dark-bg min-h-screen">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white dark:bg-dark-surface p-10 rounded-2xl border border-brand-100 dark:border-dark-border shadow-sm">
      ...
      <section className="py-20 px-4 bg-brand-50 dark:bg-dark-surface">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="bg-white dark:bg-dark-card p-8 rounded-2xl border border-brand-100 dark:border-dark-border shadow-sm text-center">
