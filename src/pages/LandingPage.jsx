...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen pt-16 bg-white dark:bg-dark-bg">
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
          <ScrollReveal animation="fade-left" className="lg:col-span-6 text-center lg:text-left mb-16 lg:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Link to="/demo" className="inline-flex justify-center items-center gap-2 bg-white dark:bg-dark-surface border-2 border-brand-200 dark:border-dark-border hover:border-brand-300 dark:hover:border-slate-700 text-brand-800 dark:text-white px-8 py-3.5 rounded-xl font-semibold transition-all hover:bg-brand-50 dark:hover:bg-dark-card">
                Interactive Demo
              </Link>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal animation="fade-right" delay={200} className="lg:col-span-6 relative">
            <div className="relative rounded-2xl bg-gradient-to-br from-brand-100 to-white dark:from-dark-surface dark:to-dark-bg border border-brand-200 dark:border-dark-border shadow-2xl p-6 overflow-hidden">
              ...
              <div className="relative z-10 space-y-4">
                ...
                <div className="bg-white dark:bg-dark-card p-4 rounded-xl shadow-sm border border-brand-100 dark:border-dark-border/50 max-w-[80%]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <ScrollReveal key={idx} animation="zoom" delay={idx * 120}>
              <div className="bg-white dark:bg-dark-surface p-8 rounded-2xl border border-brand-100 dark:border-dark-border shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group h-full">
      ...
      <section className="py-20 px-4 border-b border-brand-100 dark:border-dark-border">
        <div className="max-w-7xl mx-auto w-full text-center">
          <ScrollReveal animation="fade-up">
            <h2 className="text-2xl font-bold text-brand-900 dark:text-white mb-12">Trusted by Professionals, Chosen by the Industry</h2>
          </ScrollReveal>
          <div className="flex flex-wrap justify-center gap-8 md:gap-24">
            {[
              { num: "50K+", label: "Consumers" },
              { num: "10K+", label: "Students" },
              { num: "5K+", label: "Professionals" },
              { num: "200+", label: "Firms" }
            ].map((stat, idx) => (
              <ScrollReveal key={idx} animation="zoom" delay={idx * 150}>
                <div className="flex flex-col items-center">
                  <span className="text-4xl md:text-5xl font-extrabold text-accent-600 dark:text-accent-500 mb-2">{stat.num}</span>
                  <span className="text-sm font-semibold text-brand-600 dark:text-slate-400 uppercase tracking-widest">{stat.label}</span>
                </div>
              </ScrollReveal>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <ScrollReveal key={idx} animation="fade-up" delay={idx * 150}>
                <div className="bg-white dark:bg-dark-surface p-8 rounded-2xl shadow-sm border border-brand-100 dark:border-dark-border h-full">
      ...
      <section className="py-24 px-4">
        <ScrollReveal animation="zoom">
          <div className="max-w-4xl mx-auto w-full bg-gradient-to-br from-brand-100 to-white dark:from-dark-surface dark:to-dark-bg border border-brand-200 dark:border-dark-border rounded-3xl p-12 text-center shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              <a href="#" className="w-full sm:w-auto flex justify-center items-center gap-2 text-brand-700 dark:text-slate-300 font-semibold px-8 py-4 hover:text-accent-600 dark:hover:text-accent-400 transition-colors">
