      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {teamMembers.map((member, idx) => {
            ...
            return (
              <div key={idx} className="bg-white dark:bg-dark-surface rounded-2xl border border-brand-100 dark:border-dark-border shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group">
